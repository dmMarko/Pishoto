...
// import frc.LibPurple.swerve.Control.TrajectoryFollower;
// import frc.LibPurple.swerve.Swerve.SwerveDrivetrain;
// import frc.LibPurple.swerve.trajectories.TrajectoryS;
// import frc.robot.Robot;


// public class HolonomicMotionProfiledTrajectoryFollower3075 extends TrajectoryFollower<HolonomicDriveSignal> {
...
//     public HolonomicMotionProfiledTrajectoryFollower3075(SwerveDrivetrain drivetrain, PIDvalue translationConstants, PIDvalue rotationConstants,
...
//     protected HolonomicDriveSignal cal(){
//         RigidTransform2D currentPos = new RigidTransform2D(drivetrain.getKinematicPosition(), drivetrain.getAngle());
//         // return new HolonomicDriveSignal(translation, rotation, true);
//         return null;
//     }

//     @Override
//     protected HolonomicDriveSignal calculateDriveSignal(RigidTransform2D currentPose, Vector2D velocity,
//                                                double rotationalVelocity, TrajectoryS trajectory, double time,
//                                                double dt) {
