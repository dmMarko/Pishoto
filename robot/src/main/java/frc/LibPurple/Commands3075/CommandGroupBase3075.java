...
* Add your docs here.
*/
public abstract class CommandGroupBase3075 extends CommandBase implements Command{
    ...
    */
    public abstract void addParallel(Command commands);
    public abstract void addSequential(Command commands);
