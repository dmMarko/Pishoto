...
public class PID254 {
     ...
     */
    public PID254(double Kp, double Ki, double Kd) {
        setPIDF(Kp, Ki, Kd, 0);
    }
     ...
     */
    public PID254(double Kp, double Ki, double Kd, double Kf) {
        setPIDF(Kp, Ki, Kd, Kf);
    }
    ...
    public double calculate(double input, double dt) {
        ...
        if (Utils.inRange(m_error * m_P, m_minimumOutput, m_maximumOutput)) {
        ...
        double returnResult = m_result;
        if(returnResult >= m_maximumOutput){
